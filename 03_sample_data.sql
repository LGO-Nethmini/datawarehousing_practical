...
(1,  'James',   'Smith',   'james.smith@email.com',   '9001111111', '12 Oak St',   'New York',   'NY', '10001', TO_DATE('2023-01-15', 'YYYY-MM-DD')),
(2,  'Sarah',   'Johnson', 'sarah.j@email.com',       '9002222222', '34 Pine Ave', 'Los Angeles', 'CA', '90001', TO_DATE('2023-03-20', 'YYYY-MM-DD')),
(3,  'Robert',  'Brown',   'rob.brown@email.com',     '9003333333', '56 Elm Rd',   'Chicago',    'IL', '60601', TO_DATE('2023-05-10', 'YYYY-MM-DD')),
(4,  'Emily',   'Davis',   'emily.d@email.com',       '9004444444', '78 Maple Dr', 'Houston',    'TX', '77001', TO_DATE('2023-07-22', 'YYYY-MM-DD')),
(5,  'Michael', 'Wilson',  'mike.w@email.com',        '9005555555', '90 Cedar Ln', 'Phoenix',    'AZ', '85001', TO_DATE('2023-09-05', 'YYYY-MM-DD')),
(6,  'Jessica', 'Taylor',  'jess.t@email.com',        '9006666666', '11 Birch Ct', 'New York',   'NY', '10002', TO_DATE('2024-01-08', 'YYYY-MM-DD')),
(7,  'David',   'Martinez','david.m@email.com',       '9007777777', '22 Walnut St','Los Angeles', 'CA', '90002', TO_DATE('2024-02-14', 'YYYY-MM-DD')),
(8,  'Ashley',  'Anderson','ashley.a@email.com',      '9008888888', '33 Spruce Ave','Chicago',   'IL', '60602', TO_DATE('2024-04-19', 'YYYY-MM-DD')),
(9,  'Daniel',  'Thomas',  'dan.t@email.com',         '9009999999', '44 Ash Blvd', 'Houston',    'TX', '77002', TO_DATE('2024-06-30', 'YYYY-MM-DD')),
(10, 'Laura',   'Jackson', 'laura.j@email.com',       '9010000000', '55 Poplar Way','Phoenix',   'AZ', '85002', TO_DATE('2024-08-11', 'YYYY-MM-DD'));
...
(1,  1,  1, 1, TO_DATE('2025-01-05', 'YYYY-MM-DD'),  2, 1200.00, 'Credit Card'),
(2,  2,  2, 2, TO_DATE('2025-01-10', 'YYYY-MM-DD'),  5,   25.00, 'Cash'),
(3,  3,  3, 3, TO_DATE('2025-01-15', 'YYYY-MM-DD'),  3,   45.00, 'Debit Card'),
(4,  4,  4, 4, TO_DATE('2025-01-20', 'YYYY-MM-DD'),  1,  350.00, 'Credit Card'),
(5,  5,  5, 5, TO_DATE('2025-01-25', 'YYYY-MM-DD'),  2,   90.00, 'Cash'),
(6,  6,  1, 2, TO_DATE('2025-02-03', 'YYYY-MM-DD'),  1, 1200.00, 'Credit Card'),
(7,  7,  6, 1, TO_DATE('2025-02-08', 'YYYY-MM-DD'),  4,   75.00, 'Debit Card'),
(8,  8,  7, 3, TO_DATE('2025-02-14', 'YYYY-MM-DD'),  2,  110.00, 'Cash'),
(9,  9,  8, 4, TO_DATE('2025-02-20', 'YYYY-MM-DD'),  3,   80.00, 'Credit Card'),
(10, 10, 9, 5, TO_DATE('2025-02-25', 'YYYY-MM-DD'),  1,  320.00, 'Cash'),
(11, 1,  2, 1, TO_DATE('2025-03-01', 'YYYY-MM-DD'),  6,   25.00, 'Credit Card'),
(12, 2,  3, 2, TO_DATE('2025-03-06', 'YYYY-MM-DD'),  4,   45.00, 'Debit Card'),
(13, 3,  1, 3, TO_DATE('2025-03-12', 'YYYY-MM-DD'),  3, 1200.00, 'Credit Card'),
(14, 4,  4, 4, TO_DATE('2025-03-18', 'YYYY-MM-DD'),  2,  350.00, 'Cash'),
(15, 5,  5, 5, TO_DATE('2025-03-22', 'YYYY-MM-DD'),  5,   90.00, 'Debit Card'),
(16, 6,  6, 1, TO_DATE('2025-04-04', 'YYYY-MM-DD'),  2,   75.00, 'Credit Card'),
(17, 7,  7, 2, TO_DATE('2025-04-10', 'YYYY-MM-DD'),  3,  110.00, 'Cash'),
(18, 8,  8, 3, TO_DATE('2025-04-16', 'YYYY-MM-DD'),  4,   80.00, 'Credit Card'),
(19, 9,  9, 4, TO_DATE('2025-04-22', 'YYYY-MM-DD'),  1,  320.00, 'Debit Card'),
(20, 10,10, 5, TO_DATE('2025-04-28', 'YYYY-MM-DD'),  6,   35.00, 'Cash'),
(21, 1,  1, 1, TO_DATE('2025-05-03', 'YYYY-MM-DD'),  1, 1200.00, 'Credit Card'),
(22, 2,  4, 2, TO_DATE('2025-05-09', 'YYYY-MM-DD'),  2,  350.00, 'Debit Card'),
(23, 3,  5, 3, TO_DATE('2025-05-15', 'YYYY-MM-DD'),  3,   90.00, 'Cash'),
(24, 4,  6, 4, TO_DATE('2025-05-21', 'YYYY-MM-DD'),  4,   75.00, 'Credit Card'),
(25, 5,  7, 5, TO_DATE('2025-05-27', 'YYYY-MM-DD'),  2,  110.00, 'Cash'),
(26, 6,  8, 1, TO_DATE('2025-06-02', 'YYYY-MM-DD'),  5,   80.00, 'Debit Card'),
(27, 7,  9, 2, TO_DATE('2025-06-08', 'YYYY-MM-DD'),  1,  320.00, 'Credit Card'),
(28, 8, 10, 3, TO_DATE('2025-06-14', 'YYYY-MM-DD'),  8,   35.00, 'Cash'),
(29, 9,  2, 4, TO_DATE('2025-06-20', 'YYYY-MM-DD'),  6,   25.00, 'Credit Card'),
(30, 10, 3, 5, TO_DATE('2025-06-26', 'YYYY-MM-DD'),  4,   45.00, 'Debit Card'),
(31, 1,  1, 2, TO_DATE('2025-07-05', 'YYYY-MM-DD'),  2, 1200.00, 'Credit Card'),
(32, 2,  5, 3, TO_DATE('2025-07-11', 'YYYY-MM-DD'),  3,   90.00, 'Cash'),
(33, 3,  7, 4, TO_DATE('2025-07-17', 'YYYY-MM-DD'),  5,  110.00, 'Debit Card'),
(34, 4,  8, 5, TO_DATE('2025-07-23', 'YYYY-MM-DD'),  4,   80.00, 'Credit Card'),
(35, 5,  1, 1, TO_DATE('2025-08-01', 'YYYY-MM-DD'),  3, 1200.00, 'Cash'),
(36, 6,  4, 2, TO_DATE('2025-08-07', 'YYYY-MM-DD'),  1,  350.00, 'Credit Card'),
(37, 7,  6, 3, TO_DATE('2025-08-13', 'YYYY-MM-DD'),  6,   75.00, 'Debit Card'),
(38, 8,  9, 4, TO_DATE('2025-08-19', 'YYYY-MM-DD'),  2,  320.00, 'Cash'),
(39, 9, 10, 5, TO_DATE('2025-08-25', 'YYYY-MM-DD'),  7,   35.00, 'Credit Card'),
(40, 10, 2, 1, TO_DATE('2025-09-02', 'YYYY-MM-DD'),  5,   25.00, 'Debit Card'),
(41, 1,  3, 2, TO_DATE('2025-09-08', 'YYYY-MM-DD'),  4,   45.00, 'Cash'),
(42, 2,  1, 3, TO_DATE('2025-09-14', 'YYYY-MM-DD'),  2, 1200.00, 'Credit Card'),
(43, 3,  5, 4, TO_DATE('2025-09-20', 'YYYY-MM-DD'),  6,   90.00, 'Cash'),
(44, 4,  7, 5, TO_DATE('2025-09-26', 'YYYY-MM-DD'),  3,  110.00, 'Debit Card'),
(45, 5,  8, 1, TO_DATE('2025-10-04', 'YYYY-MM-DD'),  4,   80.00, 'Credit Card'),
(46, 6,  4, 2, TO_DATE('2025-10-10', 'YYYY-MM-DD'),  2,  350.00, 'Cash'),
(47, 7,  6, 3, TO_DATE('2025-10-16', 'YYYY-MM-DD'),  5,   75.00, 'Credit Card'),
(48, 8,  9, 4, TO_DATE('2025-10-22', 'YYYY-MM-DD'),  1,  320.00, 'Debit Card'),
(49, 9,  1, 5, TO_DATE('2025-11-01', 'YYYY-MM-DD'),  4, 1200.00, 'Credit Card'),
(50, 10, 2, 1, TO_DATE('2025-11-07', 'YYYY-MM-DD'),  8,   25.00, 'Cash');
